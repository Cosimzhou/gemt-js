...
(function() {
  ...
  m = [
  // bar 1
  mark("parenleft"), [0, [8, 16]], [4, 16], [7, 8], [7, 8],
  // bar 2
  [9], [7],
  // bar 3
  ...
  //  你笑起来真好看
  m = [
    mark("parenleft"), 1, 2, 5, 2, 1, 2, 5, 2, mark("parenright"), barl(3),
    [-5, 8], [3, 8], [3, 8], [-5, 8], [-5, 8], [2, 8], 2, //bar 3
    [1, 8], [1, 8], [1, 8], [2, 8], [3, 8], [-5, 8], -5,
    [-6, 8], [1, 8], [1, 8], [-6, 8], [-5, 8], [3, 8], 3,
    mark("segno"), [2, 8], [1, 8], [1, 8], [-6, 8], 2, 0, // bar 6
  ...
  //  浪花
  m = [
    [-6, 8], [-7, 8], 1, -6, [2, 2], 1, [-7, [4, 8]], [1, 8], [2, 8], [4, 8],
    [3, [2, 4]], [-6, 8], [-7, 8], 1, -6, [2, 2], 1, [-7, 8], [-6, 8], -7, -7,
    [-7, [2, 4]],

    [-6, 8], [-7, 8], 1, -6, [2, 2], 1, [-7, [4, 8]], [1, 8], [2, 8], [4, 8],
    [3, [2, 4]], [-6, 8], [-7, 8], 1, -6, [2, 2], 1, [-7, [4, 8]], [-6, 8], -7,
    [-6, [2, 4]],


    [3, 8], [3, 8], 3, 3, 4, 3, 2, [-7, [4, 8]], [1, 8], 2, [3, [2, 4]], [3, 8],
    [3, 8], 3, 3, 3, 4, 3, [2, [4, 8]], [1, 8], -7, [-6, [2, 4]],

    [3, 8], [3, 8], 3, 3, 3, 4, 5, [6, [4, 8]], [5, 8], 4, [3, [2, 4]], [3, 8],
    [3, 8], 3, 3, 2, 3, 2, [1, [4, 8]], [-7, 8], -6, [-6, [2, 4]],
