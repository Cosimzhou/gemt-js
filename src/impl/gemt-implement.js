...
function DImageDict() {
  this.dict = {
    ...
    "natural":      new DImage("natural.svg",          {ay: 8, w: 4, h: 15.2}),// sx: 0.8, sy: 0.8,
    ...
    "fullnote":     new DImage("note_full.svg",        {ax: 0.8, ay: 4, w: 12.6, h: 8.1}),

    "notetail-d":   new DImage("note_tail-down.svg",   {ax: 0.8, ay: 15, w: 12.6, h: 8.1}),
    "notetail":     new DImage("note_tail-up.svg",     {ax: 0.8, ay: 0.5, w: 12.6, h: 8.1}),

    "fermata":      new DImage("fermata.svg",          {ax: 0.8, ay: 5, w: 17, h: 12}),
...
exports['GContext'].prototype.printImpl = function(p = 0){
  ...
  for (var op, i = range[0][0], ops = this.strokes(); i < range[0][1]; ++i) {
    op = ops[i].symbol();
    switch (op.kind) {
      case 'line':
        ctx.moveTo(op.x, op.y);
